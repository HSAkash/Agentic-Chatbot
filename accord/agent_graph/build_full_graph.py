...
from accord.agent_graph.agent_backend import State, BasicToolNode, route_tools, plot_agent_schema
...
def build_graph():
    ...
    """
    primary_llm = ChatGroq(model_name="llama3-8b-8192")
    graph_builder = StateGraph(State)
    # Load tools with their proper configs
    search_tool = load_tavily_search_tool(TOOLS_CFG.sql_agent.tavily_search_max_results)
    tools = [search_tool] + RAGTool.tools + [query_sqldb]
